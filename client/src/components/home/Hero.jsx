        ...
        <div className='absolute top-4 left-4 right-4 z-40 sm:hidden'>
          ...
          <div>
            ...
            <div className={`sm:hidden flex gap-3 justify-center mt-8 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0'}`}>
              <Link
                to="/membership"
                className="group relative w-32 px-4 py-2.5 rounded-full font-bold text-xs shadow-2xl transition-all duration-300 transform hover:scale-105 overflow-hidden inline-block text-center"
                style={{
              ...
              <Link
                to="/classes"
                className="group relative w-32 px-4 py-2.5 rounded-full font-bold text-xs border-2 transition-all duration-300 transform hover:scale-105 backdrop-blur-sm inline-block text-center"
                style={{
                  borderColor: '#FACC15',
                  color: '#FACC15',
        ...
        <div className="container sm:mt-25 px-4 sm:px-6 z-20 relative">
          <div className="max-w-4xl mx-auto text-center sm:text-left">
            ...
            <div className={`hidden sm:flex flex-row gap-6 mb-8 sm:mb-12 md:mb-16 transition-all duration-1000 items-center sm:items-start ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <Link
                to="/membership"
                className="group relative flex-none px-8 md:px-10 py-4 rounded-full font-bold text-base md:text-lg shadow-2xl transition-all duration-300 transform hover:scale-105 overflow-hidden inline-block"
                style={{
                  background: 'linear-gradient(135deg, #FACC15 0%, #F59E0B 100%)',
                  color: '#000000',
                  boxShadow: '0 0 20px rgba(250, 204, 21, 0.4)'
              ...
              <Link
                to="/classes"
                className="group relative flex-none px-8 md:px-10 py-4 rounded-full font-bold text-base md:text-lg border-2 transition-all duration-300 transform hover:scale-105 backdrop-blur-sm inline-block"
                style={{
                  borderColor: '#FACC15',
                  color: '#FACC15',
                  background: 'rgba(0, 0, 0, 0.3)'
