      ...
      <div className="relative max-w-7xl mx-auto z-20">
          ...
          {filteredClasses.map((cls, idx) => (
            ...
            >
              ...
              <div className="relative p-4 md:p-8 min-h-48 md:h-full flex flex-col">
                ...
                <Link 
                  to="/register"
                  className={`relative block w-full py-3 md:py-4 rounded-xl md:rounded-2xl bg-gradient-to-r ${cls.color} text-black font-bold transform transition-all duration-300 hover:shadow-2xl hover:shadow-black/20 group-hover:scale-105 active:scale-95 overflow-hidden text-sm md:text-base text-center cursor-pointer`}
                  onClick={(e) => {
                    console.log('Book Now clicked - navigating to /register');
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-white/20 transform -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out pointer-events-none"></div>
                </Link>
              </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-block p-1 bg-gradient-to-r from-yellow-500 to-red-500 rounded-2xl">
            <Link 
              to="/classes" 
              className="block bg-gray-900 px-8 py-4 rounded-xl font-semibold text-white hover:bg-gray-800 transition-all duration-300 transform hover:scale-105"
            >
              Explore All Classes →
            </Link>
          </div>
